...
import { loadSharedPdfEngine } from "#/lib/pdf-thumbnail-utils.ts";
...
} from "#/components/extend/document-viewer-sidebar.tsx";
            ...
            <ToolbarTooltip label="Zoom in">
              <Button
                ...
                onClick={() => {
                  ...
                  onZoomChange(nextZoom ?? ZOOM_OPTIONS[ZOOM_OPTIONS.length - 1]);
                }}
              >
    ...
    >
      <ScrollArea className="size-full min-h-0">
        <div
          ...
          className={cn("min-h-full", viewportPropsClassName, viewportClassName)}
        >
          {children}
        </div>
      </ScrollArea>
