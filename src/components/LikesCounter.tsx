...
const USERS = [
  {
    id: "user-1",
    name: "Nova Studio",
    avatar: "https://iimydr2b8o.ufs.sh/f/Zqn6AViLMoTtHnKrXgkK7FlZGQ2nWi4Jzv0TXU9DVkAd5yE1",
  },
  {
    id: "user-2",
    name: "Growth Lab",
    avatar: "https://iimydr2b8o.ufs.sh/f/Zqn6AViLMoTtIYuGoisEhfWHMxKLVXD5ouFcBtgk6enZS0OG",
  },
  {
    id: "user-3",
    name: "Personal Workspace",
    avatar: "https://iimydr2b8o.ufs.sh/f/Zqn6AViLMoTtqpB1uxNk0UapbrAxOtRg9jDGu8sZzWLf2VM1",
  },
  {
    id: "user-4",
    name: "Personal Workspace",
...
export function NativeLikesCounterSubtle() {
  return (
    <Container>
      <NativeLikesCounter count={42} users={USERS.slice(0, 2)} variant="subtle" />
    </Container>
  );
}
    ...
    <Container>
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <p className="text-xs text-muted-foreground max-w-[200px]">
          Hover to see popup. Click "Load more" to fetch additional users (simulated).
        </p>
      </div>
    </Container>
  );
